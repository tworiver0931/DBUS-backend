...
const tokenAddressPath = path.join(path.dirname(__dirname), 'artifacts', 'DTicketAddress.bin')
...
async function deploy() {
  ...
  const deployedAddressPath = path.join(path.dirname(__dirname), 'artifacts', 'FundRegistryAddress.bin');
